...
import { clearCart } from '../redux/cartSlice'; // ✅ Ensure the correct path
                        ...
                        {shippingToggle && (
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="address" placeholder='Enter Address' className='w-full px-3 py-2 border mb-2' onChange={(e) => setShippingInfo({ ...shippingInfo, address: e.target.value })} />
                                </div>
                                <div>
                                    <label className='block text-gray-700'>City</label>
                                    <input type="text" name="city" placeholder='Enter City' className='w-full px-3 py-2 border mb-2' onChange={(e) => setShippingInfo({ ...shippingInfo, city: e.target.value })} />
                                </div>
                                <div>
                                    <label className='block text-gray-700'>Zip Code</label>
                                    <input type="number" name="zip" placeholder='Enter Zip Code' className='w-full px-3 py-2 border mb-2' onChange={(e) => setShippingInfo({ ...shippingInfo, zip: e.target.value })} />
                                </div>
                            </div>
                        )}
                    </div>
